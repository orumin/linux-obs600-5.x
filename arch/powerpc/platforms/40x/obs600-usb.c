...
static int __init ppc405ex_usb_otg_probe(struct platform_device *ofdev)
{
...
static int __exit ppc405ex_usb_otg_remove(struct platform_device *ofdev)
{
	/* Nothing to do here */
	return 0;
}
...
static struct platform_driver ppc405ex_usb_otg_driver = {
	...
	.remove = __exit_p(ppc405ex_usb_otg_remove),
};
